...
class TritonConfig:
    ...
    unique_kernel_names: bool = os.environ.get("TORCHINDUCTOR_UNIQUE_KERNEL_NAMES") == "1"
    ...
    persistent_reductions: bool = True
    ...
    max_block: Dict[str, int] = {"X": 2048, "Y": 1024, "Z": 1024}
...
max_autotune_pointwise:bool = os.environ.get("TORCHINDUCTOR_MAX_AUTOTUNE_POINTWISE") == "1"

# enable slow autotuning passes to select gemm algorithms
max_autotune_gemm:bool = os.environ.get("TORCHINDUCTOR_MAX_AUTOTUNE_GEMM") == "1"

# enable searching global and local cache regardless of `max_autotune`
search_autotune_cache:bool = os.environ.get("TORCHINDUCTOR_SEARCH_AUTOTUNE_CACHE") == "1"
...
developer_warnings: bool = is_fbcode()
